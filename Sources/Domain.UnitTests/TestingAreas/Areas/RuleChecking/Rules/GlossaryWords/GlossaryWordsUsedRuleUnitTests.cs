...
using Mmu.WordAnalyzer2.Domain.Areas.RuleChecking.Rules.GlossaryWords;
using Mmu.WordAnalyzer2.WordAccess.Areas.Models;
using Moq;
using Xunit;

namespace Mmu.WordAnalyzer2.Domain.UnitTests.TestingAreas.Areas.RuleChecking.Rules.GlossaryWords
{
    public class GlossaryWordsUsedRuleUnitTests
    {
        ...
        public async Task CheckingRule_AllGlossaryWordsUsed_ReturnsPassed()
        {
            ...
            cell2.Setup(f => f.Words).Returns(
                new List<IWord>
                {
                    word2.Object
                });

            glossaryTableMock.Setup(f => f.Cells).Returns(
                new List<ICell>
                {
                    cell1.Object,
                    cell2.Object
